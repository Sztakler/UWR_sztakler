...
; Testy pożyczone od Cezarego Świtały

(provide parse typecheck)

#|
(: cooperation (-> String String String))
(define (cooperation member1 member2)
  (string-append "Zadanie wykonane w kooperacji z " member1 " " member2))

(cooperation "Jakub Skalski" "Piotr Dobiech")
|#
